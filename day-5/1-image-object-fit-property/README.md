...
The object-fit property controls how an image or video resizes to fill its own defined box. [1, 2]
...
- Squeezes or stretches the image to exactly match the target dimensions.
  - Stretches the image, destroying its original aspect ratio. [4, 5]
- contain
- Scales the image down or up to fit entirely inside the box.
  - Preserves the aspect ratio, which often leaves empty letterbox spaces. [6, 7]
- cover
- Scales the image to completely fill the box, cropping the edges if needed.
  - Preserves the aspect ratio, making it ideal for banners and cards. [8, 9]
- none
